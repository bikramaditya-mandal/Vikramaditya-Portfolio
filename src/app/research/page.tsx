        ...
        subTopics: [
          {
            ...
            images: [
              { src: '/assets/Fig_HD_He_sigma_page-0001.jpg', alt: 'HD + He integral cross sections', caption: 'Integral cross sections for HD + He rotational quenching' },
              { src: '/assets/Fig_HD_He_exp_v2_page-0001.jpg', alt: 'HD + He H-SARP comparison v=2', caption: 'Comparison with H-SARP experimental angular distribution (v = 2)' },
            ],
          ...
          },
          {
            ...
            images: [
              { src: '/assets/Fig_D2_Ne_exp_old_page-0001.jpg', alt: 'D₂ + Ne DCS comparison thermal', caption: 'DCS comparison with thermal crossed-beam experiments' },
              { src: '/assets/Fig_D2_Ne_ICS_L_Lp_page-0001.jpg', alt: 'D₂ + Ne ICS partial wave analysis', caption: 'Partial-wave resolved ICS showing l = 5 shape resonance' },
              { src: '/assets/Fig_D2_Ne_HSARP_XSARP_page-0001.jpg', alt: 'D₂ + Ne H-SARP vs X-SARP', caption: 'Comparison with H-SARP and X-SARP experimental angular distributions' },
            ],
          ...
          },
          {
            ...
            images: [
              { src: '/assets/Fig_HD_D2_sigma_1200_1000_1002_page-0001.jpg', alt: 'HD + D₂ cross sections', caption: 'State-to-state cross sections for HD + D₂ collisions' },
              { src: '/assets/Fig_HD_D2_HSARP_VSARP_dj1_page-0001.jpg', alt: 'HD + D₂ SARP Δj=−1 comparison', caption: 'H-SARP and V-SARP comparison for Δj = −1 transition' },
              { src: '/assets/Fig_HD_D2_VSARP_dj2_page-0001.jpg', alt: 'HD + D₂ SARP Δj=−2 comparison', caption: 'H-SARP and V-SARP comparison for Δj = −2 transition' },
              { src: '/assets/Fig_HD_D2_exp_454_703_meV_page-0001.jpg', alt: 'HD + D₂ DCS thermal comparison', caption: 'DCS comparison at 454 and 703 meV collision energies' },
            ],
        ...
        subTopics: [
          {
            ...
            images: [
              { src: '/assets/Fig_H2O_H2O_sigma_vs_dE.png', alt: 'H₂O cross sections vs ΔE', caption: 'Cross sections as a function of energy gap ΔE showing exponential behavior' },
              { src: '/assets/Fig_H2O_H2O_MLP_fig_page-0001.jpg', alt: 'MLP neural network architecture', caption: 'Multi-layer perceptron architecture for rate coefficient prediction' },
              { src: '/assets/Fig_H2O_H2O_TACS_Trot300_page-0001.jpg', alt: 'TACS comparison Trot=300K', caption: 'MQCT vs MLP thermally-averaged cross sections at T = 300 K' },
            ],
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        images: [
          { src: '/assets/AstroPAH.png', alt: 'Polycyclic aromatic hydrocarbon structure', caption: 'PAH molecular structure relevant to ISM collisional studies' },
        ],
      },
    ],
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        images: [
          { src: '/assets/PhD_acknowledgement.png', alt: 'PhD thesis acknowledgement', caption: 'From the PhD thesis — Marquette University, 2021' },
        ],
      },
    ],
  },
