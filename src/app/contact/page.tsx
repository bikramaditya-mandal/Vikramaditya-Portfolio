  ...
  return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto px-16 py-16 grid grid-cols-[1fr_1.4fr] gap-20 items-start max-lg:grid-cols-1 max-lg:gap-12 max-md:px-6">
        ...
        <FadeUp>
          <div>
            ...
            <div className="py-6 border-b border-white/[0.08]">
              <span className="block font-sans text-[0.68rem] font-semibold tracking-[0.2em] uppercase text-accent mb-2">Email</span>
              <a href="mailto:bikramaditya.mandal@unlv.edu" className="font-sans text-[0.9rem] text-cream hover:text-accent transition-colors">
            ...
            {/* Location */}
            <div className="py-6 border-b border-white/[0.08]">
              <span className="block font-sans text-[0.68rem] font-semibold tracking-[0.2em] uppercase text-accent mb-2">Location</span>
              <p className="font-sans text-[0.9rem] text-cream leading-[1.7]">
            ...
            {/* CV */}
            <div className="py-6 border-b border-white/[0.08]">
              <span className="block font-sans text-[0.68rem] font-semibold tracking-[0.2em] uppercase text-accent mb-3">CV</span>
              <a
            ...
            {/* Research interests */}
            <div className="py-6 border-b border-white/[0.08]">
              <span className="block font-sans text-[0.68rem] font-semibold tracking-[0.2em] uppercase text-accent mb-3">Research Interests</span>
              <div className="flex flex-wrap gap-2">
                {tags.map(t => (
                  <span key={t} className="font-sans text-[0.68rem] font-medium text-muted bg-[#1a1a1a] border border-white/[0.08] rounded-full px-3 py-1">
                    {t}
                  </span>
                ))}
              </div>
        ...
        {/* Right — social cards */}
        <FadeUp delay={100}>
          <span className="section-label mb-8 block">Find Me Online</span>
          <div className="space-y-3">
            {socials.map(s => (
              <a
                ...
                className="flex items-center gap-5 p-5 bg-[#141414] border border-white/[0.08] rounded-lg transition-all hover:border-accent hover:translate-x-1 group"
              >
                {/* Icon */}
                <div
                ...
                >
                  {s.isEmail ? (
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="#0d0d0d" strokeWidth="2">
                ...
                <div className="flex-1">
                  <p className="font-sans text-[0.88rem] font-semibold text-cream">{s.name}</p>
                  <p className="font-mono text-[0.72rem] text-muted">{s.desc}</p>
                </div>
                <span className="text-muted text-sm transition-all group-hover:text-accent group-hover:translate-x-0.5 group-hover:-translate-y-0.5">↗</span>
              </a>
            ))}
          </div>
        </FadeUp>
      ...
      {/* Visitor counter */}
      <div className="text-center py-8 px-16 border-t border-white/[0.08]">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
